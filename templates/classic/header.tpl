...
<style type="text/css">
<!--
body { background: $VARS[pbgcolor]; }
.lazTop a, .lazTop a:visited, .lazTop a:active { color: $VARS[top_link_color]; }
.lazTop table a, .lazTop table a:visited, .lazTop table a:active { color: $VARS[link_color]; }
...
.lazTop { background: $VARS[pbgcolor]; font-family: $VARS[font_face]; font-size: $VARS[tb_font_2]; color: $VARS[laz_top_font_color]; text-align: left; width: $VARS[width]; margin: 3px auto; }
.lazTopNum { color: $VARS[laz_top_num_color]; font-weight:bold; }
